...
public class Venda {
    ...
    private List<Venda_Produto> venda = new ArrayList<>(); // Chave mapeada na classe Venda_Produto
     ...
     */
    public List<Venda_Produto> getProduto() {
        return venda;
    }
     ...
     */
    public void setProduto(List<Venda_Produto> venda) {
        this.venda = venda;
    }
